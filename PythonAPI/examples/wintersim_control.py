...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            self.player = self.world.try_spawn_actor(blueprint, spawn_point)
        # Set up the sensors.
        self.collision_sensor = CollisionSensor(self.player, self.hud_wintersim)
        self.lane_invasion_sensor = LaneInvasionSensor(self.player, self.hud_wintersim)
...
class HUD_WINTERSIM(object):
    ...
    def render(self, display, world):
        if self.is_hud:
            ...
            logo = pygame.transform.scale(logo, (525,122))
...
def game_loop(args):
    ...
    try:
        ...
        weather = Weather(client.get_world().get_weather()) #weather object to update carla weather with sliders
