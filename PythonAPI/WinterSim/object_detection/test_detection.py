...
from object_detection.utils.kitti_yolo_dataset import KittiYOLODataset
...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights_path", type=str, default="checkpoints/yolov3_ckpt_epoch-60_MAP-0.52.pth", help="path to weights file")
