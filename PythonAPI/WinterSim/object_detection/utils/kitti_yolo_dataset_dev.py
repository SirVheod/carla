...
import numpy as np
import random
from object_detection.utils.kitti_dataset import KittiDataset
import object_detection.utils.kitti_aug_utils as augUtils
...
class KittiYOLO2WayDataset(KittiDataset):
    def __init__(self, root_dir, points, split='sample', folder='sampledata'):
        super().__init__(root_dir=root_dir, split=split, folder=folder)
        self.sample_id_list = []
