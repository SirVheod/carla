...
from object_detection.utils import config as cnf
from object_detection.utils import kitti_bev_utils as bev_utils
...
def build_targets(pred_boxes, pred_cls, target, anchors, ignore_thres):
    ...
    return iou_scores, class_mask, obj_mask.bool(), noobj_mask.bool(), tx, ty, tw, th, tim, tre, tcls, tconf