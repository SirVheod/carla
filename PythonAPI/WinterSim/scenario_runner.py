...
class ScenarioRunner(object):
    ...
    def _run_openscenario(self):
        ...
        # Load the scenario configurations provided in the config file
        #print(self._args.openscenario)

        # instead of needing to give exact full path to xosc file, you can simply give --openscenario path as:
        # --openscenario /scrunner/examples/Slalom.xosc
        pathname = os.path.dirname(sys.argv[0])
        folder = os.path.abspath(pathname)
        path = folder + self._args.openscenario
        self._args.openscenario = path
